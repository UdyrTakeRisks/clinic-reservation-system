...
export class DoctorPageComponent implements OnInit {
  ...
  viewDoctorSlots() {
    ...
    this.http.get<any[]>(environment.environmenturl + '/clinic/view/doctorSlot').subscribe(
      (response) => {
        this.slots = response;
  ...
  fetchDoctorNotifications() {
    ...
    const apiUrl = environment.environmenturl + '/clinic/notify/doctor';
  ...
  addNewSlot() {
    ...
    if (this.newSlotDate && this.newSlotHour) {
      ...
      if (formattedHour) {
        ...
        this.http.post<any>(environment.environmenturl + '/clinic/create/doctorSlot', newSlot).subscribe(
          (response) => {
  ...
  saveChanges() {
    ...
    if (this.newSlotDate && this.newSlotHour) {
      ...
      const apiUrl = environment.environmenturl + '/clinic/update/doctorSlot';
  ...
  // Delete Slot
  cancelSlot(slot: any) {
    const apiUrl = environment.environmenturl + '/clinic/cancel/doctorSlot';
