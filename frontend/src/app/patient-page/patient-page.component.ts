...
export class PatientPageComponent implements OnInit {
  ...
  fetchDoctorNames() {
    this.http.get<any[]>(environment.environmenturl + '/clinic/view/doctorNames').subscribe(
      (response) => {
  ...
  fetchPatientAppointments() {
    ...
    this.http.get<any[]>( environment.environmenturl + '/clinic/view/patientAppointment').subscribe(
      (response) => {
  ...
  fetchAvailableSlots(doctorName: string) {
    ...
    const apiUrl = environment.environmenturl + '/clinic/view/AvailableSlots/' + doctorName;
  ...
  createAppointment() {
    ...
    const apiUrl = environment.environmenturl + '/clinic/create/patientAppointment';
  ...
  cancelSlot(slot: any) {
    ...
    if (formattedDate && formattedTime) {
      ...
      const apiUrl = environment.environmenturl + '/clinic/cancel/patientAppointment';
